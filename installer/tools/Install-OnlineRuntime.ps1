...
if ($ModelMode -eq 'download') {
    ...
    [IO.File]::WriteAllText($downloadMarker, 'downloaded-by=0.9.1' + [Environment]::NewLine, [Text.UTF8Encoding]::new($false))
} else {
...
$config = @(
    '# Generated by FR SAM Text Selection 0.9.1 installer'
    'schemaVersion=2'
