...
> 适用版本：FR SAM 文本选区 0.9.2 Pre-release
>
> 更新日期：2026-09-07
...
1. 运行 FR-SAM-Text-Selection-Backend-0.9.2-Windows-x64.exe。升级前等待任务结束，建议退出 Photoshop。
2. 选择模型来源：
...
8. 提交并推送源码，创建 GitHub v0.9.2 Pre-release，上传两个安装包和校验文件。已发布资产不可原地替换；后续修复增加版本号。
